...
public class NewStudentDao {
    ...
    String[] tm = (String[] ) result.get(1);
    Connection conn = DBConnection.getSecondConnection();
    ...
    public boolean addNewStudent(Student student) {
        //(student_name,student_password,student_sex,student_number,data_base)
     ...
     * @return
     */
    public boolean deleteNewStudent(int studentId) {
     ...
     * @return
     */
    public Student getNewStudentById(int studentId) {
        // Connection conn = DBConnection.getSecondConnection();
        //String sql = "select * from newstudent where stu_id = " + studentId;
